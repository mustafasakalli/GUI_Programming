...
public class MainActivity extends AppCompatActivity implements BoardView {
    ...
    public void gameEnded(byte winner) {
        ...
        switch (winner) {
            case BoardView.DRAW:
                Toast.makeText(this, "Game is Draw :P", Toast.LENGTH_LONG).show();
                break;
            case BoardView.PLAYER_1_WINNER:
                Toast.makeText(this, "Player 1 Wins, Congratz!", Toast.LENGTH_LONG).show();
                break;
            case BoardView.PLAYER_2_WINNER:
                Toast.makeText(this, "Player 2 Wins, Congratz!!", Toast.LENGTH_LONG).show();
                break;
        }
    }
}
